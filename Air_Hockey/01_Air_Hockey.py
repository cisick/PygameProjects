...
while running:
    ...
    player1_score_text = font.render(f"{player_scores[0]}", True, RED)
    format_score_text = font.render(f":", True, WHITE)
    player2_score_text = font.render(f"{player_scores[1]}", True, BLUE)
    screen.blit(player1_score_text, (540 - player1_score_text.get_width(), 20))
    screen.blit(player2_score_text, (window_width - player2_score_text.get_width() - 535, 20))
    screen.blit(format_score_text, (window_width/2-5, 20))
    pygame.draw.circle(screen, WHITE, (int(ball_x), int(ball_y)), ball_radius)
    pygame.display.flip()

    screen.blit(player1_score_text, (570-5, 20))
    screen.blit(player2_score_text, (window_width - 575, 20))
    screen.blit(format_score_text, (window_width/2-5, 20))
